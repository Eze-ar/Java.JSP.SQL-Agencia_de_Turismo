                ...
                <div class="wrapper wrapper--w790">
                    <div class="card card-5" style="margin-top: 80px;"> <!-- agrego style para que no me pise el navbar -->
                        <div class="card-heading">
                            <h2 class="title">Servicio Turístico</h2>
                        </div>
                        <div class="card-body">
                            <form action="SvServicio" method="POST">
                                ...
                                <div class="form-row">
                                    <div class="name"><span>Tipo de servicio</span></div>
                                    <select name="tipo_servicio" style="height:50px">
                                        ...
                                        <option value="Pasajes de avion">Pasajes de avion</option> 
                                ...
                                <div class="form-row">
                                    <div class="name">Descripción breve</div>
                                    <div class="value">
                                        <div class="input-group">
                                ...
                                <div class="form-row">
                                    <div class="name">Destino servicio</div>
                                    <div class="value">
                                        <div class="input-group">
                                ...
                                <div class="form-row">
                                    <div class="name">Fecha servicio</div>
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="date" name="fecha_servicio">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="name">Costo servicio</div>
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="number" step="0.01" min=0 name="costo">
                                        </div>
                                    </div>
                                </div>
