            ...
            <div class="container d-flex align-items-center">
                ...
                <nav id="navbar" class="navbar order-last order-lg-0">
                    <ul>
                        ...
                        <!--pongo a EMPLEADOS como clase activa -->
                        <li class="dropdown"><a href="#" class="active"><span>EMPLEADOS</span> <i class="bi bi-chevron-down"></i></a>
                            <ul>
            ...
            <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
                <div class="wrapper wrapper--w790">
                    <div class="card card-5" style="margin-top: 80px;"> <!-- agrego style para que no me pise el navbar -->
                        ...
                        <div class="card-body">
                            <form action="SvEditaEmpleado" method="POST">
                                <!-- pongo a dónde envío el formulario a mi Servlet SvEditaEmpleado y con qué método: POST -->    
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="text" name="direccion" value="<%=empleado.getDireccion()%>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="text" name="dni" value="<%=empleado.getDni()%>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        ...
                                        <div class="input-group">
                                            <%
                                                Date fecha_nac = empleado.getFecha_nac();
                                                String fecha_nac_str = new SimpleDateFormat("yyyy-MM-dd").format(fecha_nac);
                                                /*esto en forma similar (pero opuesta obvio) a lo que hice en lista-clientes y empleados*/
                                            %>
                                            <input class="input--style-5" type="date" name="fecha_nac" value="<%=fecha_nac_str%>">
                                            <!-- la fecha a mostrar en value debe estar en formato yyyy-MM-dd !!! -->
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="text" name="nacionalidad" value="<%=empleado.getNacionalidad()%>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="text" name="celular" value="<%=empleado.getCelular()%>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="email" name="email" value="<%=empleado.getEmail()%>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="text" name="cargo" value="<%=empleado.getCargo()%>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="number" step="0.01" min=0 name="sueldo" value="<%=empleado.getSueldo()%>">
                                            <label>sólo números con hasta 2 decimales</label>
                                            <!--para el sueldo limito que sea con 2 decimales y nros positivos! -->
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="text" name="usuario" value="<%=empleado.getUsuario().getNombre()%>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="password" name="password" value="<%=empleado.getUsuario().getPassword()%>">
                                        </div>
                                    </div>
                                </div> 
                                      <input type="hidden" name="id_Empleado" value="<%=empleado.getId_empleado()%>">
                                <div>
                                    <button class="btn btn--radius-2 btn--red" type="submit">Aceptar</button>
                                </div>
                            </form>
                        </div>
                    </div>
