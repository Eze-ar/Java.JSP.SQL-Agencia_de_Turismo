                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="SvLeeEmpleado" method="POST"> <!--observar que mando al servlet que lee el empleado con método POST en primer lugar -->
                                        <input type="hidden" name="id_Empleado" value="<%=id_Empleado%>"> <!--no olvidar del cierre del input! -->
