                ...
                <nav id="navbar" class="navbar order-last order-lg-0">
                    <ul>
                        <li><a href="index.jsp">INICIO</a></li>
                                         <!--pongo a Servicios como clase activa -->
            ...
            <div class="page-wrapper bg-gra-03 p-t-45 p-b-50"> <!-- agrego esto para mantener -->
                ...
                <div class="card card-5" style="margin-top: 80px;"> <!-- agrego style para que no me pise el navbar -->
                    <div class="card-heading">
                        <h2 class="title">Listado de Servicios</h2>
                    </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                %>
                                <td><%=fecha_str%></td> <!-- muestro la fecha formateada (String) -->
                                <%Double costo = s.getCosto_servicio();%>
                                <td><%=costo%></td>
                                <%int codigo = s.getCodigo_servicio();%>
                                <td>    <!--quito action="SvLeeServicio" pues no lo implementé -->
                                    <form method="POST"> <!--observar que mando al servlet que lee el servicio con método POST en primer lugar -->
