            ...
            <div class="container d-flex align-items-center">
                ...
                <nav id="navbar" class="navbar order-last order-lg-0">
                    <ul>
                        ...
                        <!--pongo a PAQUETE como clase activa -->
                ...
                <div class="wrapper wrapper--w790">
                    <div class="card card-5" style="margin-top: 80px;"> <!-- agrego style para que no me pise el navbar -->
                        <div class="card-heading">
                            <h2 class="title">Paquete Turístico</h2>
                        </div>
                        <div class="card-body">
                            <form action="SvPaquete" method="POST">
                                ...
                                <div class="form-row">
                                    <div class="name">Lista Servicios</div>
                                    <select name="cod_servicio1" style="height:50px">
                                        <%for (Servicio_Turistico s : listaServicios) {
                                            if (s.getEstado().equals("ACTIVO")) {
                                        %><option value="<%=s.getCodigo_servicio()%>"><%=s.getNombre()%></option>
                                        <%} }%> <!-- paso el cod de servicio y luego con esto obtengo costo, nombre, etc -->
                                    </select>
                                 </div>
                                <div class="form-row">  
                                    <div class="name">Lista Servicios</div>
                                    <select name="cod_servicio2" style="height:50px">
                                        <%for (Servicio_Turistico s : listaServicios) {
                                                if (s.getEstado().equals("ACTIVO")) {
                                        %><option value="<%=s.getCodigo_servicio()%>"><%=s.getNombre()%></option>
                                        <%} }%> 
                                ...
                                <div class="form-row">
                                    <div class="name">Lista Servicios</div>
                                    <select name="cod_servicio3" style="height:50px">
