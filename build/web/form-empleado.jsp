                    ...
                    <div class="card card-5" style="margin-top: 80px;"> <!-- agrego style para que no me pise el navbar -->
                        ...
                        <div class="card-body">
                            <form action="SvEmpleado" method="POST">
                                <!-- pongo a dónde envío el formulario, a mi Servlet Empleado y con qué método: POST -->    
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="date" name="fecha_nac">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="number" step="0.01" min=0 name="sueldo">
