...
<html lang="es-AR">
    ...
    <body>
        <% //chequeo de sesión activa con user/pass válidos
            ...
            //recibo cliente del SvLeeCliente a través de la sesión:
            //(casteo porque recibo un objeto session y lo paso a Cliente)
            ...
            <div class="container d-flex align-items-center">
                ...
                <nav id="navbar" class="navbar order-last order-lg-0">
                    <ul>
                        ...
                        <li class="dropdown"><a href="#" class="active"><span>CLIENTES</span> <i class="bi bi-chevron-down"></i></a>
                            <ul>
                        ...
                        <li class="dropdown"><a href="#"><span>EMPLEADOS</span> <i class="bi bi-chevron-down"></i></a>
                            <ul>
                                <li><a href="form-cliente.jsp">ALTA EMPLEADO</a></li>
            ...
            <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
                <div class="wrapper wrapper--w790">
                    <div class="card card-5" style="margin-top: 80px;"> <!-- agrego style para que no me pise el navbar -->
                        ...
                        <div class="card-body">
                            <form action="SvEditaCliente" method="POST">
                                <!-- pongo a dónde envío el formulario a mi Servlet SvEditaCliente y con qué método: POST -->    
                                        ...
                                        <div class="row row-space">
                                            <div class="col-2">
                                                <div class="input-group-desc">
                                                    <input class="input--style-5" type="text" name="nombre" value="<%=cliente.getNombre()%>">
                                                    <label class="label--desc">Nombre</label>
                                                </div>
                                            </div>
                                            <div class="col-2">
                                                <div class="input-group-desc">
                                                    <input class="input--style-5" type="text" name="apellido" value="<%=cliente.getApellido()%>">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="text" name="direccion" value="<%=cliente.getDireccion()%>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="text" name="dni" value="<%=cliente.getDni()%>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="text" name="nacionalidad" value="<%=cliente.getNacionalidad()%>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="text" name="celular" value="<%=cliente.getCelular()%>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="email" name="email" value="<%=cliente.getEmail()%>">
                                        </div>
                                    </div>
                                </div>
